...
hidden if the `XnYSZ_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `XnYSZ_DEVELOPER_MODE` to the configure
...
Runs the executable target `XnYSZ_exe`.
