...
hidden if the `XnYZip_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `XnYZip_DEVELOPER_MODE` to the configure
...
Runs the executable target `XnYZip_exe`.
