...
hidden if the `tonSZ_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `tonSZ_DEVELOPER_MODE` to the configure
...
Runs the executable target `tonSZ_exe`.
